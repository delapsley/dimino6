...
init() ->
    error_logger:info_msg("m6_x3c_test:init_test()~n"),
...
parse() ->
    Data = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><x3c_cmd><name><check_data/></name><retval>ok</retval><reason>cool</reason><params><param><pname>volumeName</pname><type>string</type><value>myvolumename</value></param><param><pname>projectName</pname><type>string</type><value>myprojectname</value></param><param><pname>interfaceName</pname><type>string</type><value>myinterfacename</value></param></params></x3c_cmd>",
    ...
    error_logger:info_msg("Param_records: ~p~n", [lists:map(fun(X) -> X#param.pname end, Param_records)]). 
